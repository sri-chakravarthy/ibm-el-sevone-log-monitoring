...
#mkdir -p %{buildroot}/var/custom/ps-addon/%{appname}/incoming
#mkdir -p %{buildroot}/var/custom/ps-addon/%{appname}/archive


#/bin/sed -i "s,APPNAMEREPLACE,%{appname},g" %{SOURCE0}/etc/cronjob.yml
...
#/opt/SevOne/%{appname}/bin/*.sh
#/opt/SevOne/%{appname}/src/*.py
#/opt/SevOne/%{appname}/cronjob.yml
/var/custom/ps-addon/%{appname}config.json
/var/custom/ps-addon/%{appname}LogMonitoring.py
